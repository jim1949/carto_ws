...
class StartTrajectoryRequest(genpy.Message):
  _md5sum = "43bc2f400a20b882d4e814954643af02"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4Bi.pack(_x.options.provide_odom_frame, _x.options.use_odometry, _x.options.use_laser_scan, _x.options.use_multi_echo_laser_scan, _x.options.num_point_clouds))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.options.provide_odom_frame, _x.options.use_odometry, _x.options.use_laser_scan, _x.options.use_multi_echo_laser_scan, _x.options.num_point_clouds,) = _struct_4Bi.unpack(str[start:end])
      ...
      self.options.use_laser_scan = bool(self.options.use_laser_scan)
      self.options.use_multi_echo_laser_scan = bool(self.options.use_multi_echo_laser_scan)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
class StartTrajectory(object):
  ...
  _md5sum = '2349ff4a5129c9a200718d93bfbb5ed3'
